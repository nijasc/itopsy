...
<svelte:head>
	<title>Admin Audit Log — ITopsy admin</title>
</svelte:head>
...
<main class="mx-auto flex max-w-4xl flex-col gap-6 px-4 py-8">
	<div>
		...
		<p class="text-surface-600-400 text-sm">
			Every case file opened, amended, published, or sealed by the editorial staff. Deletions and
			personnel matters are above your clearance level.
		</p>
	</div>
				...
				<li class="card bg-surface-100-900 flex items-start justify-between gap-4 p-4">
					<div>
						<div class="mb-1 flex items-center gap-2">
							...
							<span class="text-surface-600-400 text-xs">{entry.actorEmail}</span>
						</div>
